...
Smart contracts MUST implement all of the functions in the KIP37TokenReceiver interface to accept transfers. See “Safe Transfer Rules” for further detail.
