...
The terms public key and proof-of-possession (denoted by pop) are from the ciphersuite [BLS_SIG_BLS12381G1_XMD:SHA-256_SSWU_RO_POP\_](https://www.ietf.org/archive/id/draft-irtf-cfrg-bls-signature-05.html#section-4.2.3). Things to note:
